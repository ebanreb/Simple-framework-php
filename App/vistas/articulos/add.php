<div class="x_panel">
	<div class="x_title"><h2>Nuevo Articulo</h2><div style="clear:both;"></div></div>
	<div id="form_nuevo_articulo">
		<form method="post" action="<?= ROOT?>articulos/add.html" name="formNuevoArticulo" accept-charset="UTF-8" />
			 <div class="x_content"><button class="btn btn-default" type="submit" name="enviar" id="btn_enviar">aceptar</button></div>
